...
const message = 'An organization intends to design and implement a system with a trusted server supplying services to client applications, used by their collaborators.';
const private_key = fs.readFileSync('./data/45a78b4f3456/keys/privateKey.pem', 'utf-8');
const public_key = fs.readFileSync('./data/45a78b4f3456/keys/publicKey.pem', 'utf-8');
...
msgs.forEach(msg => {
    ...
    const signatureCheck = Cryptography.checkSign(public_key, msg.msg, msg.signature);
